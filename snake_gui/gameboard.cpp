...
//palautetaan pään kordinaatit
const Point &GameBoard::getHeadCoordintes()
{
    return snake_.back();
}
//palautetaan hännän koordinaatit
const Point &GameBoard::getTailCoordintes()
{
    return snake_.front();
}
//palautetaan ruoan kordinaatit
const Point &GameBoard::getFoodCoordinates()
{
    return food_;
}
//palautetaan käärmeen pituus
int GameBoard::getSnakelength()
{
    return static_cast<int>(snake_.size());
}
//vektori jossa käärmeen osien koordinaatit
std::vector<Point> GameBoard::getSnakeParts()
{

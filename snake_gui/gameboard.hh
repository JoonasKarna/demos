/* gameboard.hh
 *
 * valmispohja mikä toteuttaa graafisen pelilaudan "backend" toiminnot
 * Valmispohjaan lisätty seuraavat omat metodit
 *
 * getHeadCoordinates(), palauttaa käärmeen pään koordinaatit
 * getTailCoordinates(), palauttaa käärmeen hännän koordinaatit
 * getFoodCoordinates(), palauttaa ruoan koordinaatit
 * getSnakeLength(), palauttaa käärmeen pituuden
 * getSnakeParts(), palauttaa vektorin jossa jossa käärmeen osat
 *
...
public:
    ...
    //palauttaa käärmeen pään koordinaatit
    const Point& getHeadCoordintes();
    //palauttaa hännän koordinaatit
    const Point& getTailCoordintes();
    //palauttaa ruoan koordinaatit
    const Point& getFoodCoordinates();
    //palauttaa käärmeen pituuden
    int getSnakelength();
    //palauttaa vektorin jossa käärmeen osat
    std::vector<Point> getSnakeParts();
